...
with st.sidebar:
    ...
    **Mermaind** adalah tool pintar yang membantu akademisi, peneliti, dan praktisi membuat flow diagram hanya dengan menulis deskripsi singkat. Tanpa perlu ribet menggambar manual, Mermaind langsung mengubah prompt menjadi kode Mermaid/Graphviz, lalu merendernya menjadi diagram vector (SVG/PNG) yang tajam dan siap dipakai di paper, laporan, maupun presentasi.
    ...
    15. [Blockchain Healthcare Revolution](https://healthchain.streamlit.app/)
    16. [Academic Flow Diagram Generator](https://mermaind.streamlit.app/)
    17. [Numerical Methods Lab](https://metnumlab.streamlit.app/)
    18. [Computational Analytics Studio](https://komnumlab.streamlit.app/)
    19. [BlockBook](https://blockbook.streamlit.app/)
...
# URL Ohara
iframe_url = "https://ohara.ai/mini-apps/473fdcb5-5fc8-42f0-a63e-6ae2ab077600"
